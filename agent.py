...
- "restart com-manh-cp-order"          → {{"mode": "skill", "skill": "restart", "name": "com-manh-cp-order", "kind": null, "namespace": null, "field": null, "cluster_name": null, "zone": null, "project": null, "action": null, "explicit_pod": false, "name_filter": null}}
...
- "is com-manh-cp-order down"          → {{"mode": "skill", "skill": "describe", "name": "com-manh-cp-order", "kind": null, "namespace": null, "field": "status", "cluster_name": null, "zone": null, "project": null, "action": null, "explicit_pod": false, "name_filter": null}}
- "is com-manh-cp-order running"       → {{"mode": "skill", "skill": "describe", "name": "com-manh-cp-order", "kind": null, "namespace": null, "field": "status", "cluster_name": null, "zone": null, "project": null, "action": null, "explicit_pod": false, "name_filter": null}}
- "is com-manh-cp-order down in mtstackom3 cluster" → {{"mode": "skill", "skill": "describe", "name": "com-manh-cp-order", "kind": null, "namespace": null, "field": "status", "cluster_name": "mtstackom3", "zone": null, "project": null, "action": null, "explicit_pod": false, "name_filter": null}}
...
- "list com-manh-cp-order"             → {{"mode": "skill", "skill": "list", "name": null, "kind": null, "namespace": null, "field": null, "cluster_name": null, "zone": null, "project": null, "action": null, "explicit_pod": false, "name_filter": "com-manh-cp-order"}}
- "list com-manh-cp-order pod"         → {{"mode": "skill", "skill": "list", "name": null, "kind": "pod", "namespace": null, "field": null, "cluster_name": null, "zone": null, "project": null, "action": null, "explicit_pod": false, "name_filter": "com-manh-cp-order"}}
...
- "any pod restarting in mtstackom3"  → {{"mode": "skill", "skill": "status", "name": null, "kind": null, "namespace": null, "field": null, "cluster_name": "mtstackom3", "zone": null, "project": null, "action": null, "explicit_pod": false, "name_filter": null}}
...
- "scale com-manh-cp-snh to 1"             → {{"mode": "skill", "skill": "scale", "name": "com-manh-cp-snh", "kind": null, "namespace": null, "field": null, "cluster_name": null, "zone": null, "project": null, "action": null, "explicit_pod": false, "name_filter": null, "replicas": 1}}
...
- "scale snh deployment to 1 in mtstackom3 cluster" → {{"mode": "skill", "skill": "scale", "name": "snh", "kind": "deployment", "namespace": null, "field": null, "cluster_name": "mtstackom3", "zone": null, "project": null, "action": null, "explicit_pod": false, "name_filter": null, "replicas": 1}}
